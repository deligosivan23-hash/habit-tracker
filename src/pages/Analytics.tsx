...
function DangerZone() {
  ...
  return (
    <motion.div
      ...
      className="mt-4 mb-8"
    >
      <div className="border border-danger/20 rounded-2xl p-5 bg-danger/5">
        <h3 className="font-display text-base text-danger mb-1">Danger zone</h3>
        <p className="text-text-muted text-xs mb-4">
          Clear all habits and logs permanently. This cannot be undone.
        </p>
      ...
      <Modal isOpen={showConfirm} onClose={() => setShowConfirm(false)} title="Clear all data?" size="sm">
        <p className="text-text-secondary text-sm mb-2">
          This will permanently delete <strong className="text-text-primary">all habits, logs, and streaks</strong>.
        </p>
        <p className="text-danger text-xs mb-5">There is no undo.</p>
